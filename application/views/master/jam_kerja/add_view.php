	...
	<div class="col-md-6">
		<form class="form-horizontal" role="form" method="POST" action="">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="master_jam_masuk" class="form-control" id="master_jam_masuk" required="required" placeholder="hh:mm" maxlength="5">
				</div>
			</div>
			<div class="form-group">
				<label for="master_jam_keluar" class="col-sm-4 control-label">Jam Keluar</label>
				<div class="col-sm-8">
					<input type="text" name="master_jam_keluar" class="form-control" id="master_jam_keluar" required="required" placeholder="hh:mm" maxlength="5">
				</div>
			</div>
			<div class="form-group">
				<label for="master_keterangan" class="col-sm-4 control-label">Keterangan</label>
				<div class="col-sm-8">
					<input type="text" name="master_keterangan" class="form-control" id="master_keterangan" placeholder="Keterangan">
				</div>
			</div>
			<div class="form-group">
